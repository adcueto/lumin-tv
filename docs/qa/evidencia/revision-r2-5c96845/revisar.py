...
SHA = '5c96845413f3ce11474d5123ee95fae9a63827d6'
...
def extraer():
    ...
    seleccion = [p for p in archivos if p.startswith(('servidor/tests/', 'roku-app/', 'docs/coordinacion/')) or p == 'servidor/servidor_lumin.py']
    hashes = {}
    for p in seleccion:
