...
| F23 | Recargar desde el panel (B5a) | Pulsar ↻ en la tarjeta de la pantalla **sin cambiar la lista** (respuesta idéntica), luego otra vez tras cambiar un elemento, y una tercera con el WAN cortado | En los tres casos la TV corta lo que estaba y arranca la lista desde el primer elemento en su siguiente latido (≤ 4 s con red); nunca se queda en negro; sin red reproduce lo que tiene; en el panel desaparece el "último error" si lo había |
