...
> Protocolo inicial conservado como antecedente. El formato, responsabilidades y estado actual están en [16-coordinacion-agentes.md](16-coordinacion-agentes.md). La matriz siguiente incluye criterios futuros SaaS; no todos corresponden al bloque activo. El apartado final de resultados es histórico.
