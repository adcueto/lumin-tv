...
Sin la variable, los 68 ensayos se **omiten** (no pasan): no hay resultado
inventado. Resultado en el entorno de desarrollo (PostgreSQL 16.13, psycopg
3.2.3): 68 pasan en 14 s; sin variable, 68 omitidos. El rol de la variable
